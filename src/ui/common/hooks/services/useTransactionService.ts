...
export const useTransactionService = () => {
  ...
  const { createBtcStakingManager, createCustomBtcStakingManager } =
  ...
  const createDelegationEoi = useCallback(
    async (
      ...
      const msg: { value: EncodeObject | EncodeObject[] } = { value: [] };
      const btcStakingManager = createCustomBtcStakingManager(msg);
