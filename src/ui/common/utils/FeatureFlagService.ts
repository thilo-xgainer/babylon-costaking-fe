 ...
 * variables should be prefixed with REACT_APP_FF_
 *
 * Rules:
 * 1. All feature flags must be defined in this file for easy maintenance
 * 2. All feature flags must start with REACT_APP_FF_ prefix
...
export default {
   ...
   */
  get IsLedgerEnabled() {
    return process.env.REACT_APP_FF_ENABLE_LEDGER === "true";
  },
   ...
   */
  get IsPhase3Enabled() {
    return process.env.REACT_APP_FF_PHASE_3 === "true";
  },
  ...
  get IsBabyStakingEnabled() {
    return process.env.REACT_APP_FF_BABYSTAKING === "true";
  },
};
