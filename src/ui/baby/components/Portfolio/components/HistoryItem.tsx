...
export const HistoryItem: React.FC<Props> = ({ history }) => {
  return (
    <div className="flex items-center px-8 py-4 text-sm">
      ...
      <div className="flex w-[25%] items-center justify-center gap-1 px-2 text-left">
        <a
      ...
      <div className="flex w-[15%] items-center justify-end gap-1 px-2 text-left">
        {ubbnToBaby(Number(history.amount))}{" "}
